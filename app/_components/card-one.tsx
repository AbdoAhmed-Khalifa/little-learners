...
export default function CardOne({
  ...
  return (
    <section className="relative h-full rounded-xl border-2 border-dark-15 pb-[30px] pl-[30px] pr-10 pt-[50px] shadow-[6px_6px_0_2px_rgpa(30,30,30,1)] shadow-[#1E1E1E] md:px-[50px] md:pb-[50px] md:pt-20">
